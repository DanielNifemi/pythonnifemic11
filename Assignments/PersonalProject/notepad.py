# create an app that allows user to input and store notes.
# the notes should be stored in a file.
# the app should also allow the user to view the notes.
# the app should also allow the user to delete the notes.
# the app should also allow the user to search the notes.
